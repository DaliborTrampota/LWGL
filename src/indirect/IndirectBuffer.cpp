...
void IndirectBuffer::add(PoolAllocation alloc, const glm::mat4& model) {
    DrawArraysIndirectCommand cmd{
        .count = alloc.count, .primCount = 1, .offset = alloc.offset, .baseInstance = 0
    };
